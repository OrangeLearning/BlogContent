---
title: Vim 配置
date: 2018-04-22 22:31:48
tags: [algorithm]
---
#  [ Linux Vim 配置 ](https://blog.csdn.net/kissacm/article/details/78349287)
...
```
想更换VIM配色打朋友可以查看自己vim*/colors，下面打 ` *.vim ` 文件即可更改对应的主题。

虽然很好用，可是我用SpaceVim，(逃...